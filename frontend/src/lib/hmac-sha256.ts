/**
 * HMAC-SHA256 that works on non-secure origins (HTTP AP at bingo.local / 192.168.4.1).
 * Web Crypto `subtle` is unavailable outside secure contexts.
 */
...
function sha256(message: Uint8Array): Uint8Array {
  ...
  const padLen = ((withOne + 8 + 63) & ~63) - 8;
